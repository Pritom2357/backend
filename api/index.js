...
app.get('/api/applovin', async (req, res) => {
    try {
        const apiResponse = await fetch(`https://r.applovin.com/maxReport?api_key=${applovinApiKey}&start=2024-11-22&end=2024-12-31&columns=day,estimated_revenue,country,network,application&sort_day=DESC&format=json`);
